...
use AdHocSportsGames\SQL\GameSQL;
...
class GameController implements ControllerInterface {
    ...
    public function handleGetAll($request, $response, $args) {
        $wrapper = (new GameSQL(new DatabaseConnection()))->selectAll();
    ...
    public function handleGet($request, $response, $args) {
        $wrapper = (new GameSQL(new DatabaseConnection()))->select($args['id']);
        return $response->withJson($wrapper->toArray(), $wrapper->getCode());
    }
    ...
    public function handlePost($request, $response, $args) {
        $wrapper = (new GameSQL(new DatabaseConnection()))->insert($request->getBody());
        return $response->withJson($wrapper->toArray(), $wrapper->getCode());
    }
    ...
    public function handlePut($request, $response, $args) {
        $wrapper = (new GameSQL(new DatabaseConnection()))->fullyUpdate($request->getBody(), $args['id']);
        return $response->withJson($wrapper->toArray(), $wrapper->getCode());
    }
    ...
    public function handlePatch($request, $response, $args) {
        $wrapper = (new GameSQL(new DatabaseConnection()))->partiallyUpdate($request->getBody(), $args['id']);
        return $response->withJson($wrapper->toArray(), $wrapper->getCode());
    }
    ...
    public function handleDelete($request, $response, $args) {
        $wrapper = (new GameSQL(new DatabaseConnection()))->delete($args['id']);
        return $response->withJson($wrapper->toArray(), $wrapper->getCode());
    }
}